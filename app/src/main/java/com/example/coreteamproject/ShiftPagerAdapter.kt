...
/**
 * Adapter per gestire i fragment delle schede nella sezione Turni dell'admin.
 * Questo adapter determina quale fragment mostrare per ogni posizione della scheda.
 */
class ShiftPagerAdapter(fragment: Fragment) : FragmentStateAdapter(fragment) {
    ...
    override fun createFragment(position: Int): Fragment {
        return when (position) {
            ...
            else -> throw IllegalStateException("Posizione non valida per la scheda: $position")
        }
    }
}
